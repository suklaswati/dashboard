...
// ** Actions Imports
import { fetchData } from 'src/store/apps/branch'

// ** Third Party Components
import axios from 'axios'

// ** Custom Table Components Imports
import TableHeader from 'src/views/apps/branch/TableHeader'
import AddBranchDrawer from 'src/views/apps/branch/AddBranchDrawer'
...
const getCols = toggleEditUserDrawer => {
  const columns = [
    ...
    },
    {
      ...
      renderCell: ({ row }) => {
        return (
          <Typography noWrap sx={{ fontWeight: 500, color: 'text.secondary', textTransform: 'capitalize', whiteSpace:'pre-line' }}>
            {row.address}
          </Typography>
        )
      }
    ...
    },
    {
      flex: 0.1,
      minWidth: 120,
      field: 'serviceMarketer',
      headerName: 'Service Marketer',
      renderCell: ({ row }) => {
        return (
          <Typography noWrap sx={{ color: 'text.secondary' }}>
            {row.serviceMarketer}
  ...
  return (
    <Grid container spacing={6.5}>
      ...
      <AddBranchDrawer
        ...
        branchData={editUserOpen ? branchData : undefined}
