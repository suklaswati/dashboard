...
// ** Actions Imports
import { fetchData } from 'src/store/apps/employee'

// ** Third Party Components
import axios from 'axios'

// ** Custom Table Components Imports
import TableHeader from 'src/views/apps/employee/tableheader'
import AddBranchDrawer from 'src/views/apps/employee/AddBankDrawer'
  ...
  return (
    <Grid container spacing={6.5}>
      <Grid item xs={12}>
        <Card>
          ...
          <DataGrid
            ...
            rows={store.employee && store.employee.length ? store.employee : []}
      ...
      <AddBranchDrawer
        ...
        employeeData={editUserOpen ? employeeData : undefined}
