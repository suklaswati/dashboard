...
export const fetchData = createAsyncThunk('fetchpincodedata', async (params, { getState, dispatch }) => {
    console.log(params)
    try {
        const headers = {
        ...
        const response = await axios.get(`https://habitus-admin-api.applore.in/api/v1/pincode/pincodes?search=${params?.q}`, {
            headers,
        })
